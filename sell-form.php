...
if ($_SERVER['REQUEST_METHOD'] == "POST") 
{
    ...
    // var_dump($coordinate);
    // exit;
    $query = "INSERT into sell_post (building_name,coordinate,bed,bath,floor,flat_name,image_name,image_name1,image_name2,image_name3,size,price)
        ...
        <div class="col-sm-6 contents">
            <div class="row justify-content-center">
                ...
                <div class="col-md-12" style="padding-top:30px ;">
                    <div class="mb-4">
                        <h3 style="font-family:'Spectral'">Sell your Property</h3>
                    </div>
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="flat_name" id="flat_name" required></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="flat_size" id="flat_size" required></div>
                            <div class="col-sm-2">Flat Price:</div>
                            <div class="col-sm-4"><input type="text" class="form-control" name="flat_price" id="flat_price" required></div>
                        </div>
